...
return array (
  ...
  array (
    'site_name' => '嘿嘿影视',
    'site_url' => 'heiheiys.top',
    'site_wapurl' => 'heiheiys.top',
    'site_keywords' => '嘿嘿影视,在线播放,影视,电视剧,综艺',
    'site_description' => '提供最新最快的影视资讯和在线播放',
    'site_icp' => '',
    'site_qq' => '',
    'site_email' => '',
    'install_dir' => '/',
    'site_logo' => 'http://jt.ismicool.cn/heiheilogo.png',
    'site_waplogo' => 'http://jt.ismicool.cn/heiheilogo.png',
    'template_dir' => 'vfed',
    'html_dir' => 'html',
    'mob_status' => '0',
    'mob_template_dir' => 'vfed',
    'mob_html_dir' => 'html',
    'site_tj' => '<script type="text/javascript" src="https://js.users.51.la/19887659.js"></script>',
    'site_status' => '1',
  ...
  array (
    ...
    array (
      'appid' => '20087',
      'appkey' => 'QJ4ipermQgDmO2e8w7oPhd9kz6CloqMX',
      'type' => '2',
      'act' => '1',
    ),
    'alipay' => 
  ...
  'path' => 
  array (
    'topic_index' => 'hhtopic/index',
    'topic_detail' => 'hhtopic/{id}/index',
    'vod_type' => 'hhvodtype/{id}/index',
    'vod_detail' => 'hhvod/{id}/index',
    'vod_play' => 'hhplay/{id}/index',
    'vod_down' => 'hhdown/{id}/index',
    'art_type' => 'hharttype/{id}/index',
    'art_detail' => 'hhart/{id}/index',
    'page_sp' => '-',
    'suffix' => 'html',
  ),
  'rewrite' => 
...
d/<id>   => vod/detail
vodrss-<id>   => vod/rss
p/<id>-<sid>-<nid>   => vod/play
voddown/<id>-<sid>-<nid>   => vod/down
vodshow/<id>-<area?>-<by?>-<class?>-<lang?>-<letter?>-<level?>-<order?>-<page?>-<state?>-<tag?>-<year?>   => vod/show
s/<wd?>-<actor?>-<area?>-<by?>-<class?>-<director?>-<lang?>-<letter?>-<level?>-<order?>-<page?>-<state?>-<tag?>-<year?>   => vod/search
