<?php if (!defined('THINK_PATH')) exit(); /*a:23:{s:32:"template/vfed/html/vod/play.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/public/header.html";i:1558617932;s:64:"/www/wwwroot/heiheiys.top/template/vfed/html/public/include.html";i:1558681186;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/seokey.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/themes.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/navbar.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/tabbar.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/search.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/player.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/lister.html";i:1566635727;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/detail.html";i:1558667458;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/qrcode.html";i:1559638920;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/taobao.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/relate.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/lucida.html";i:1558617932;s:64:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/picture.html";i:1558617932;s:64:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/listing.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/images.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/public/footer.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/colors.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/global.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/caches.html";i:1567233713;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/quicks.html";i:1558617932;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="fed-pops-box">
					<div class="fed-pops-hot">
						...
						<ul class="fed-pops-list fed-back-whits fed-part-rows">
							<?php $_5d6a16b4cb682=explode(',',$maccms['search_hot']); if(is_array($_5d6a16b4cb682) || $_5d6a16b4cb682 instanceof \think\Collection || $_5d6a16b4cb682 instanceof \think\Paginator): if( count($_5d6a16b4cb682)==0 ) : echo "" ;else: foreach($_5d6a16b4cb682 as $key=>$vo): ?>
...
<?php echo $vfedcc['advs']['home']['head']; endif; if($maccms['aid']==15): if($vfedcc['advs']['fits']['state']==1||$vfedcc['advs']['fits']['state']==2&&$user['user_id']==0): ?><?php echo $vfedcc['advs']['play']['head']; endif; ?>
<div class="fed-play-info fed-part-rows fed-back-whits fed-marg-top">
	<div class="fed-play-player fed-rage-head fed-part-rows fed-back-black" style="padding-top:<?php echo mac_default($vfedcc['play']['high']['pgao'],'56.25%'); ?>">
		<style type="text/css">@media(max-width:47.9375rem){.fed-play-player{padding-top:<?php echo mac_default($vfedcc['play']['high']['wgao'],'56.25%'); ?>!important}}</style>
		<div class="fed-play-loader fed-part-full"><span class="fed-part-core fed-font-xvi fed-text-white fed-text-center"><?php echo mac_default($vfedcc['play']['tips'],'正在加载...'); ?></span></div>
		<?php $vods=require('application/extra/vodserver.php');$pars=$vfedcc['play']['parse'];$play=$obj['vod_play_list'][$param['sid']]['urls'][$param['nid']]['url']; if(is_array($vods) || $vods instanceof \think\Collection || $vods instanceof \think\Paginator): if( count($vods)==0 ) : echo "" ;else: foreach($vods as $key=>$vo): 
		...
		<iframe id="fed-play-iframe" class="fed-play-iframe fed-part-full" frameborder="0" scrolling="no" allowfullscreen="true"
			data-lock="<?php echo $obj['vod_copyright']; ?>"
			data-pass="<?php echo $vfedcc['play']['pass']; ?>"
			data-auto="<?php echo $vfedcc['play']['auto']; ?>"
			data-seek="<?php echo mac_default($obj['vod_author'],'0'); ?>"
			data-code="<?php echo mac_default($popedom['code'],'1'); ?>"
			data-trys="<?php echo $GLOBALS['config']['user']['trysee']; ?>"
			data-advs="<?php echo $vfedcc['play']['advs']['state']; ?>"
			data-link="<?php echo $vfedcc['play']['advs']['link']; ?>"
			data-time="<?php echo mac_default($vfedcc['play']['advs']['time'],'5'); ?>"
			data-chat="<?php echo $vfedcc['play']['code']['state']; ?>"
			data-word="<?php echo chr(rand(65,90)).chr(rand(65,90)).chr(rand(97,122)).base64_encode($GLOBALS['config']['weixin']['gjcm1']); ?>"
			data-stat="<?php echo $obj['vod_play_list'][$param['sid']]['player_info']['ps']; ?>"
			data-pars="<?php echo mac_default($obj['vod_play_list'][$param['sid']]['server_info']['des'],mac_default($obj['vod_play_list'][$param['sid']]['player_info']['parse'],$pars)); ?>"
			data-play="<?php echo !empty($vfedcc['play']['pass'])?chr(rand(65,90)).chr(rand(65,90)).chr(rand(97,122)).base64_encode($play):$play; ?>"
			data-next="<?php if($obj['vod_play_list'][$param['sid']]['player_info']['des']=='自动连播'&&$param['nid']!=$obj['vod_play_list'][$param['sid']]['url_count']): ?><?php echo $maccms['http_type']; ?><?php echo $_SERVER['HTTP_HOST']; ?><?php echo $obj['player_info']['link_next']; endif; ?>"></iframe>
		<?php if($vfedcc['play']['code']['state']): ?>
		<div class="fed-chat-info fed-back-black fed-play-box fed-back-whits<?php if($_COOKIE['fed_wechat']): ?> fed-hidden<?php else: ?> fed-visible<?php endif; ?>">
			<div class="fed-part-core fed-part-rows fed-play-chat">
				<div class="fed-col-xs5">
					<img class="fed-padding" src="<?php echo mac_url_img($vfedcc['play']['code']['value']); ?>" width="100%"/>
				</div>
				<div class="fed-col-xs7">
					<li class="fed-padding fed-text-center fed-font-xii fed-part-eone">扫描二维码,回复<font color="red"><?php echo $GLOBALS['config']['weixin']['gjc1']; ?></font>,获取口令</li>
					<li class="fed-padding fed-text-center fed-font-xii fed-part-eone fed-play-foll">欢迎关注微信公众号</li>
					<li class="fed-padding"><input class="fed-form-info fed-rims-info fed-chat-input fed-event" data-user="<?php echo $user['user_id']; ?>" type="text" placeholder="请输入口令" maxlength="60" /></li>
		...
		<?php elseif($vfedcc['play']['advs']['state']==1||$vfedcc['play']['advs']['state']==2&&$user['user_id']==0): ?>
		<div class="fed-play-tips fed-hidden"><?php echo mac_default($vfedcc['play']['advs']['tips'],'广告倒计时'); ?>&nbsp;<span class="fed-text-white"><?php echo mac_default($vfedcc['play']['advs']['time'],'5'); ?></span></div>
		<?php endif; if($vfedcc['advs']['fits']['state']==1||$vfedcc['advs']['fits']['state']==2&&$user['user_id']==0): ?>
		<div class="fed-play-advs">
			<a class="fed-part-advs fed-text-center fed-font-xvi" href="javascript:;">×</a>
			<?php echo $vfedcc['advs']['play']['inne']; ?>
		</div>
		<?php endif; if($obj['vod_copyright']): ?>
		<div class="fed-play-confirm fed-back-black fed-play-pays fed-play-box fed-back-whits fed-event">
			<div class="fed-part-core">
				<h2 class="fed-text-center fed-font-xvi"><?php echo mac_default($vfedcc['play']['copy'],'应版权方要求！本片相关资源已关闭！请谅解'); ?></h2>
			</div>
		</div>
		<?php endif; if($vfedcc['play']['apis']): ?>
		<div class="fed-play-parse fed-play-box fed-hidden fed-conceal fed-back-whits">
			...
			<?php $vods=array_slice(array_reverse($vods),0,12); ?>
			<ul class="fed-part-layout fed-part-rows">
				<?php if(is_array($vods) || $vods instanceof \think\Collection || $vods instanceof \think\Paginator): if( count($vods)==0 ) : echo "" ;else: foreach($vods as $key=>$vo): ?>
				<li class="fed-padding fed-col-xs3">
					<a class="fed-btns-info fed-rims-info fed-visible" data-api="<?php echo stristr($vo['des'], '//') == true ? $vo['des'] : $maccms['path_tpl'] . $vo['des']; ?>" href="javascript:;"><?php echo $vo['show']; ?></a>
				</li>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
		<?php endif; ?>
		<div class="fed-play-confirm fed-back-black fed-play-pays fed-play-box fed-back-whits fed-event<?php if($popedom['code']!=1&&$popedom['code']!=''): ?> fed-visible<?php else: ?> fed-hidden<?php endif; ?>">
			<div class="fed-part-core">
				<?php if($obj['vod_points_play']==0): ?>
				<h2 class="fed-text-center fed-font-xvi"><?php if($GLOBALS['config']['user']['trysee']): ?>试看<?php echo $GLOBALS['config']['user']['trysee']; ?>分钟结束，完整观看本影片需要升级会员组，请升级后观看。<?php else: ?><?php echo $popedom['msg']; endif; ?></h2>
				<p class="fed-text-center">提示：购买VIP会员组，享受超级权限，谢谢支持。</p>
				<div class="fed-text-center">
					<?php if($user['group']['group_id']==1): ?>
					<a class="fed-btns-info fed-rims-info fed-visible fed-padding fed-margin" href="<?php echo mac_url('user/reg'); ?>">用户注册</a>
					...
					<?php else: ?>
					<a class="fed-btns-info fed-rims-info fed-visible fed-padding fed-margin" href="<?php echo mac_url('user/index'); ?>" target="_blank">会员中心</a>
					<a class="fed-btns-info fed-rims-info fed-visible fed-padding fed-margin fed-back-green" href="<?php echo mac_url('user/upgrade'); ?>" target="_blank">马上升级</a>
					<?php endif; ?>
				</div>
            	<?php else: ?>
				<h2 class="fed-text-center fed-font-xvi"><?php if($GLOBALS['config']['user']['trysee']): ?>试看<?php echo $GLOBALS['config']['user']['trysee']; ?>分钟结束，完整观看本影片需要花费<?php echo $obj['vod_points_play']; ?>积分，请支付后观看。<?php else: ?><?php echo $popedom['msg']; endif; ?></h2>
				...
				<div class="fed-text-center">
					...
					<a class="fed-btns-info fed-rims-info fed-visible fed-padding fed-margin fed-back-green fed-navs-login" href="javascript:;">立即登录</a>
					<?php else: ?>
					<a class="fed-btns-info fed-rims-info fed-visible fed-padding fed-margin" href="<?php echo mac_url('user/buy'); ?>" target="_blank">马上充值</a>
	...
	<div class="fed-play-title fed-part-rows">
		<?php if($vfedcc['advs']['fits']['state']==1||$vfedcc['advs']['fits']['state']==2&&$user['user_id']==0): if($vfedcc['advs']['play']['foot']): ?><ul class="fed-play-boxs fed-part-rows"><?php echo $vfedcc['advs']['play']['foot']; ?></ul><?php endif; endif; ?>
		<ul class="fed-play-boxs fed-padding fed-part-rows fed-col-xs12 fed-col-md6">
			<li class="fed-padding<?php if($vfedcc['play']['danmu']): ?> fed-col-xs5<?php else: ?> fed-col-xs12<?php endif; ?>">
				<span class="fed-play-text fed-visible fed-font-xvi fed-part-eone"><?php echo $obj['vod_name']; ?><?php echo $obj['vod_play_list'][$param['sid']]['urls'][$param['nid']]['name']; ?></span>
			</li>
			<?php if($vfedcc['play']['danmu']): ?>
			<li class="fed-padding fed-col-xs4"><input class="fed-form-info fed-rims-info fed-rage-input fed-event" data-user="<?php echo $user['user_id']; ?>" data-name="<?php echo $user['user_name']; ?>" type="text" placeholder="一起吐槽吧！" maxlength="60" /></li>
			<li class="fed-padding fed-col-xs1">
				<a class="fed-btns-info fed-rims-info fed-visible fed-rage-switch fed-event" href="javascript:;"><?php if($_COOKIE['fed_danmu']): ?>关<?php else: ?>开<?php endif; ?></a>
			</li>
			<li class="fed-padding fed-col-xs2">
				<a class="fed-btns-info fed-rims-info fed-visible fed-btns-green fed-rage-common fed-rage-submit fed-event" href="javascript:;">发送</a>
			</li>
			<?php endif; ?>
		</ul>
		<ul class="fed-play-boxs fed-padding fed-part-rows fed-col-xs12 fed-col-md6">
			<?php if($vfedcc['play']['apis']): ?>
			<li class="fed-padding fed-col-xs2">
				<a class="fed-btns-info fed-rims-info fed-visible fed-play-cuts fed-event" href="javascript:;">接口</a>
			</li>
			<?php endif; if($GLOBALS['config']['user']['status']): ?>
			<li class="fed-padding<?php if($vfedcc['rest']['share']['state']): ?> fed-col-xs2<?php else: ?> fed-col-xs3<?php endif; ?>">
			...
			<?php endif; ?>
			<li class="fed-padding<?php if($vfedcc['play']['apis']): ?> fed-col-xs2<?php else: ?> fed-col-xs3<?php endif; if($GLOBALS['config']['user']['status']): ?> fed-col-xs2<?php else: ?> fed-col-xs3<?php endif; ?>">
				<a class="fed-btns-info fed-rims-info fed-visible fed-play-prev<?php if($param['nid']==1): ?> fed-btns-disad<?php endif; ?>" href="<?php echo $obj['player_info']['link_pre']; ?>">上集</a>
			</li>
			<li class="fed-padding<?php if($vfedcc['play']['apis']): ?> fed-col-xs2<?php else: ?> fed-col-xs3<?php endif; if($GLOBALS['config']['user']['status']): ?> fed-col-xs2<?php else: ?> fed-col-xs3<?php endif; ?>">
				<a class="fed-btns-info fed-rims-info fed-visible fed-play-next<?php if($param['nid']==$obj['vod_play_list'][$param['sid']]['url_count']): ?> fed-btns-disad<?php endif; ?>" href="<?php echo $obj['player_info']['link_next']; ?>">下集</a>
			</li>
		</ul>
	</div>
</div>
<?php endif; ?>
<?php echo $vfedcc['advs']['play']['list']; ?>
<div class="fed-tabs-info  fed-rage-foot fed-part-rows fed-part-layout fed-back-whits fed-play-data" data-name="<?php echo mac_filter_html($obj['vod_name']); ?>" data-nums="<?php echo $obj['vod_play_list'][$param['sid']]['urls'][$param['nid']]['name']; ?>" data-show="<?php echo $obj['vod_play_list'][$param['sid']]['player_info']['show']; ?>">
	<ul class="fed-list-head fed-part-rows fed-padding">
		<?php if($obj['vod_play_list']): ?>
		<li class="fed-tabs-btns fed-part-curs fed-font-xvi fed-mart-v<?php if($maccms['aid']!=16): ?> fed-text-green<?php endif; ?>" href="javascript:;">播放列表</li>
		<?php endif; ?>
		<li class="fed-tabs-btns fed-part-curs fed-font-xvi fed-mart-v<?php if(!$obj['vod_play_list']&&!$obj['vod_down_list']): ?> fed-text-green<?php endif; ?>" href="javascript:;">剧情简介</li>
		<?php if($GLOBALS['config']['comment']['status']): ?>
		<li class="fed-tabs-btns fed-part-curs fed-font-xvi fed-mart-v" href="javascript:;">发表评论</li>
		<?php endif; if($obj['vod_down_list']): ?>
		<li class="fed-tabs-btns fed-part-curs fed-font-xvi fed-mart-v<?php if($maccms['aid']==16||!$obj['vod_play_list']): ?> fed-text-green<?php endif; ?>" href="javascript:;">下载列表</li>
		<?php endif; ?>
		<li class="fed-part-tips fed-padding"><a class="fed-tabs-errs fed-event fed-more" href="javascript:;" data-href="<?php echo mac_url('gbook/report'); ?>">报错</a></li>
	</ul>
	<div class="fed-tabs-boxs">
		<?php if($obj['vod_play_list']): ?>
		<div class="fed-tabs-item fed-drop-info<?php if($maccms['aid']!=16): ?> fed-visible<?php else: ?> fed-hidden<?php endif; ?>">
			<div class="fed-drop-boxs fed-drop-tops fed-matp-v">
				<ul class="fed-part-rows">
					<?php $count=1; if(is_array($obj['vod_play_list']) || $obj['vod_play_list'] instanceof \think\Collection || $obj['vod_play_list'] instanceof \think\Paginator): if( count($obj['vod_play_list'])==0 ) : echo "" ;else: foreach($obj['vod_play_list'] as $key=>$vo): ?>
					<li class="<?php if($vo['player_info']['from']==$obj['vod_play_list'][$param['sid']]['player_info']['from']||$param['nid'] > $obj['vod_play_list'][$vo['sid']]['url_count']): ?>fed-play-btns <?php endif; ?>fed-drop-btns fed-padding fed-col-xs3 fed-col-md2">
						<a class="fed-btns-info fed-rims-info fed-part-eone<?php if($maccms['aid']==15&&$vo['player_info']['from']==$obj['vod_play_list'][$param['sid']]['player_info']['from']): ?> fed-back-green<?php elseif($maccms['aid']!=15&&$count==1): ?> fed-back-green<?php endif; ?>" href="<?php if($vo['player_info']['from']==$obj['vod_play_list'][$param['sid']]['player_info']['from']||$param['nid'] > $obj['vod_play_list'][$vo['sid']]['url_count']): ?>javascript:;<?php else: ?><?php echo mac_url_vod_play($obj,['sid'=>$vo['sid'],'nid'=>$param['nid']]); endif; ?>"><?php echo mac_default($vo['player_info']['show'],'云播放器'); ?></a>
					</li>
					<?php $count++; endforeach; endif; else: echo "" ;endif; ?>
				</ul>
			</div>
			<div class="fed-drop-boxs fed-drop-btms fed-matp-v">
				<?php $count=1; if(is_array($obj['vod_play_list']) || $obj['vod_play_list'] instanceof \think\Collection || $obj['vod_play_list'] instanceof \think\Paginator): if( count($obj['vod_play_list'])==0 ) : echo "" ;else: foreach($obj['vod_play_list'] as $key=>$vo): ?>
				<div class="fed-play-item fed-drop-item<?php if($maccms['aid']==15&&$vo['player_info']['from']==$obj['vod_play_list'][$param['sid']]['player_info']['from']): ?> fed-visible<?php elseif($maccms['aid']!=15&&$count==1): ?> fed-visible<?php else: ?> fed-hidden<?php endif; ?>">
					...
					<ul class="fed-part-rows">
						<?php if(is_array($vo['urls']) || $vo['urls'] instanceof \think\Collection || $vo['urls'] instanceof \think\Paginator): if( count($vo['urls'])==0 ) : echo "" ;else: foreach($vo['urls'] as $key=>$sub): ?>
						<li class="fed-padding<?php if($obj['type_1']['type_name']=='电影'||$obj['type']['type_name']=='电影'||$obj['type_1']['type_name']=='综艺'||$obj['type']['type_name']=='综艺'): ?> fed-col-xs6 fed-col-sm4 fed-col-md3 fed-col-lg2<?php else: ?> fed-col-xs3 fed-col-md2 fed-col-lg1<?php endif; ?>">
							<a class="fed-btns-info fed-rims-info fed-part-eone<?php if($key==$param['nid']&&$vo['player_info']['from']==$obj['vod_play_list'][$param['sid']]['player_info']['from']): ?> fed-btns-green<?php endif; ?>" href="<?php echo mac_url_vod_play($obj,['sid'=>$vo['sid'],'nid'=>$sub['nid']]); ?>"><?php echo $sub['name']; ?></a>
						</li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						<li class="fed-padding fed-col-xs3 fed-col-md2 fed-col-lg1"><a class="fed-btns-gengduo fed-rims-info fed-part-eone fed-btns-gengduo" href="http://heiheiys.top/jx/">更多集..</a></li>
					</ul>
				</div>
				<?php $count++; endforeach; endif; else: echo "" ;endif; ?>
			</div>
		...
		<?php endif; ?>
		<div class="fed-tabs-item<?php if(!$obj['vod_play_list']&&!$obj['vod_down_list']): ?> fed-visible<?php else: ?> fed-hidden<?php endif; ?>">
	...
	<?php if($vfedcc['main']['code']): ?>
	<img class="fed-side-image" width="200" height="200" src="https://ysjtzy.oss-cn-beijing.aliyuncs.com/ewm.png" alt="公众号二维码" />
	<?php else: ?>
	<img class="fed-side-image" width="180" height="180" src="https://ysjtzy.oss-cn-beijing.aliyuncs.com/ewm.png" alt="当前网页二维码" />
	<?php endif; ?>
</div>
			</div>
			<?php endif; ?>
			<p class="fed-padding fed-part-both fed-text-muted">
				<?php echo mac_default(mac_filter_html($obj['vod_content']),'暂无剧情简介'); ?>
			</p>
		</div>
		<?php if($GLOBALS['config']['comment']['status']): ?>
		...
		<?php endif; if($obj['vod_down_list']): ?>
		<div class="fed-tabs-item fed-drop-info<?php if($maccms['aid']==16||!$obj['vod_play_list']): ?> fed-visible<?php else: ?> fed-hidden<?php endif; ?>">
			<div class="fed-drop-boxs fed-drop-tops fed-matp-v">
				<ul class="fed-part-rows">
					<?php $count=1; if(is_array($obj['vod_down_list']) || $obj['vod_down_list'] instanceof \think\Collection || $obj['vod_down_list'] instanceof \think\Paginator): if( count($obj['vod_down_list'])==0 ) : echo "" ;else: foreach($obj['vod_down_list'] as $key=>$vo): ?>
					<li class="fed-down-btns fed-drop-btns fed-padding fed-col-xs3 fed-col-md2">
						<a class="fed-btns-info fed-rims-info fed-part-eone<?php if($maccms['aid']==16&&$vo['player_info']['from']==$obj['vod_down_list'][$param['sid']]['player_info']['from']): ?> fed-back-green<?php elseif($maccms['aid']!=16&&$count==1): ?> fed-back-green<?php endif; ?>" href="javascript:;"><?php echo mac_default($vo['player_info']['show'],'云播放器'); ?></a>
					</li>
					<?php $count++; endforeach; endif; else: echo "" ;endif; ?>
				</ul>
			</div>
			<div class="fed-drop-boxs fed-drop-btms fed-matp-v">
				<?php $count=1; if(is_array($obj['vod_down_list']) || $obj['vod_down_list'] instanceof \think\Collection || $obj['vod_down_list'] instanceof \think\Paginator): if( count($obj['vod_down_list'])==0 ) : echo "" ;else: foreach($obj['vod_down_list'] as $key=>$vo): ?>
				<div class="fed-down-item fed-drop-item<?php if($maccms['aid']==16&&$vo['player_info']['from']==$obj['vod_down_list'][$param['sid']]['player_info']['from']): ?> fed-visible<?php elseif($maccms['aid']!=16&&$count==1): ?> fed-visible<?php else: ?> fed-hidden<?php endif; ?>">
					<ul class="fed-drop-head fed-padding fed-part-rows">
						<li class="fed-padding fed-col-xs4 fed-part-eone fed-font-xvi">下载集数</li>
						<li class="fed-padding fed-col-xs8 fed-part-eone fed-font-xvi fed-text-right">
							<a class="fed-drop-sort" href="javascript:;">视频排序：正序</a>
						</li>
					</ul>
					<?php if($maccms['aid']==16&&$obj['vod_points_down']==0): ?>
					<ul class="fed-part-rows">
						<?php if(is_array($vo['urls']) || $vo['urls'] instanceof \think\Collection || $vo['urls'] instanceof \think\Paginator): if( count($vo['urls'])==0 ) : echo "" ;else: foreach($vo['urls'] as $key=>$sub): ?>
						<li class="fed-part-rows fed-col-xs12">
							<div class="fed-tabs-input fed-padding fed-col-xs8 fed-col-sm9 fed-col-md10">
								<input class="fed-form-info fed-rims-info fed-part-eone" type="text" value="<?php echo $sub['url']; ?>" />
							</div>
							<div class="fed-tabs-submit fed-padding fed-col-xs4 fed-col-sm3 fed-col-md2">
								<a target="_blank" class="fed-form-info fed-btns-info fed-rims-info fed-part-eone" href="<?php echo $sub['url']; ?>">下载<?php echo $sub['name']; ?></a>
							</div>
						</li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
					<?php else: if($maccms['aid']==16&&$obj['vod_points_down']!=0&&$vo['player_info']['from']==$obj['vod_down_list'][$param['sid']]['player_info']['from']): ?>
					<ul class="fed-part-rows">
						<li class="fed-part-rows">
							...
							<div class="fed-padding fed-col-xs4 fed-col-sm3">
								<a target="_blank" class="fed-form-info fed-btns-info fed-rims-info fed-part-eone" href="<?php echo $obj['vod_down_list'][$param['sid']]['urls'][$param['nid']]['url']; ?>">下载<?php echo $obj['vod_down_list'][$param['sid']]['urls'][$param['nid']]['name']; ?></a>
							</div>
							<?php else: ?>
							...
							<div class="fed-padding fed-col-xs6 fed-col-sm2">
								<a class="fed-form-info fed-btns-info fed-rims-info fed-part-eone" href="<?php echo mac_url('user/buy'); ?>" target="_blank">马上充值</a>
							</div>
							<div class="fed-padding fed-col-xs6 fed-col-sm2">
					...
					<ul class="fed-part-rows">
						<?php if(is_array($vo['urls']) || $vo['urls'] instanceof \think\Collection || $vo['urls'] instanceof \think\Paginator): if( count($vo['urls'])==0 ) : echo "" ;else: foreach($vo['urls'] as $key=>$sub): ?>
						<li class="fed-padding<?php if($obj['type_1']['type_name']=='电影'||$obj['type']['type_name']=='电影'||$obj['type_1']['type_name']=='综艺'||$obj['type']['type_name']=='综艺'): ?> fed-col-xs4 fed-col-md2<?php else: ?> fed-col-xs3 fed-col-md2<?php endif; ?>">
							<a class="fed-btns-info fed-rims-info fed-part-eone<?php if($maccms['aid']==16&&$key==$param['nid']&&$vo['player_info']['from']==$obj['vod_down_list'][$param['sid']]['player_info']['from']): ?> fed-btns-green<?php endif; ?>" href="<?php echo mac_url_vod_down($obj,['sid'=>$vo['sid'],'nid'=>$sub['nid']]); ?>"><?php echo $sub['name']; ?></a>
						</li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
					<?php endif; ?>
...
<?php if($vfedcc['home']['taoke']['state']): ?>
...
<?php endif; if($vfedcc['home']['actor']['state']): $__TAG__ = '{"num":"1","name":"'.$obj['vod_actor'].'","key":"actors","id":"vo"}';$__LIST__ = model("Actor")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $actors = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($actors % 2 );++$actors;endforeach; endif; else: echo "" ;endif; if($actors): ?>
<div class="fed-part-layout fed-back-whits">
	<div class="fed-list-head fed-part-rows fed-padding">
