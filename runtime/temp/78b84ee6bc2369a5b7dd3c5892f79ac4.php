<?php if (!defined('THINK_PATH')) exit(); /*a:17:{s:32:"template/vfed/html/vod/show.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/public/header.html";i:1558617932;s:64:"/www/wwwroot/heiheiys.top/template/vfed/html/public/include.html";i:1558681186;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/seokey.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/themes.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/navbar.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/tabbar.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/search.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/filter.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/images.html";i:1558617932;s:64:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/listing.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/paging.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/public/footer.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/colors.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/global.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/caches.html";i:1567233713;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/quicks.html";i:1558617932;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="fed-pops-box">
					<div class="fed-pops-hot">
						...
						<ul class="fed-pops-list fed-back-whits fed-part-rows">
							<?php $_5d6a18e9ca209=explode(',',$maccms['search_hot']); if(is_array($_5d6a18e9ca209) || $_5d6a18e9ca209 instanceof \think\Collection || $_5d6a18e9ca209 instanceof \think\Paginator): if( count($_5d6a18e9ca209)==0 ) : echo "" ;else: foreach($_5d6a18e9ca209 as $key=>$vo): ?>
...
<div class="fed-casc-info fed-part-layout fed-back-whits fed-part-rows">
	<div class="fed-casc-list fed-part-rows">
		<dl>
			...
			<dd><a<?php if($vo['type_id']==$obj['type_id']||$vo['type_id']==$obj['parent']['type_id']): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($vo,[],'show'); ?>"><?php echo mac_filter_html($vo['type_name']); ?></a></dd>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</dl>
		<dl>
			<dt><?php if($obj['childids']||$obj['parent']['childids']): ?>分类<?php else: ?>类型<?php endif; ?></dt>
			<?php if($obj['childids']||$obj['parent']['childids']): ?>
			<dd><a<?php if($vo['parent']['type_id']==$obj['parent']['type_id']): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj['parent'],['area'=>$param['area'],'year'=>$param['year'],'class'=>$param['class'],'by'=>$param['by']],'show'); ?>">全部</a></dd>
			<?php else: ?>
			<dd><a<?php if($param['class']==''): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$param['year'],'class'=>'','by'=>$param['by']],'show'); ?>">全部</a></dd>
			...
			<dd><a<?php if($vo['type_id']==$obj['type_id']): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($vo,['area'=>$param['area'],'year'=>$param['year'],'class'=>$param['class'],'by'=>$param['by']],'show'); ?>"><?php echo mac_filter_html($vo['type_name']); ?></a></dd>
			<?php endforeach; endif; else: echo "" ;endif; elseif($obj['type_extend']['class']): $_5d6a18e9c9da6=explode(',',$obj['type_extend']['class']); if(is_array($_5d6a18e9c9da6) || $_5d6a18e9c9da6 instanceof \think\Collection || $_5d6a18e9c9da6 instanceof \think\Paginator): if( count($_5d6a18e9c9da6)==0 ) : echo "" ;else: foreach($_5d6a18e9c9da6 as $key=>$vo): ?>
			<dd><a<?php if($param['class']==$vo): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$param['year'],'class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
			<?php endforeach; endif; else: echo "" ;endif; elseif($obj['parent']['type_extend']['class']): ?>
			<dd><a<?php if($param['class']==''): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$param['year'],'class'=>'','by'=>$param['by']],'show'); ?>">全部</a></dd>
			<?php $_5d6a18e9c9b8e=explode(',',$obj['parent']['type_extend']['class']); if(is_array($_5d6a18e9c9b8e) || $_5d6a18e9c9b8e instanceof \think\Collection || $_5d6a18e9c9b8e instanceof \think\Paginator): if( count($_5d6a18e9c9b8e)==0 ) : echo "" ;else: foreach($_5d6a18e9c9b8e as $key=>$vo): ?>
			<dd><a<?php if($param['class']==$vo): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$param['year'],'class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
			<?php endforeach; endif; else: echo "" ;endif; else: ?>
			<dd><a<?php if($param['class']==''): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$param['year'],'class'=>'','by'=>$param['by']],'show'); ?>">全部</a></dd>
			<?php $_5d6a18e9c9a22=explode(',',$maccms['vod_extend_class']); if(is_array($_5d6a18e9c9a22) || $_5d6a18e9c9a22 instanceof \think\Collection || $_5d6a18e9c9a22 instanceof \think\Paginator): if( count($_5d6a18e9c9a22)==0 ) : echo "" ;else: foreach($_5d6a18e9c9a22 as $key=>$vo): ?>
			<dd><a<?php if($param['class']==$vo): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$param['year'],'class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
			<?php endforeach; endif; else: echo "" ;endif; endif; ?>
		</dl>
		<dl>
			<dt>地区</dt>
			<dd><a<?php if($param['area']==''): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>'','year'=>$param['year'],'class'=>$param['class'],'by'=>$param['by']],'show'); ?>">全部</a></dd>
			<?php if($obj['type_extend']['area']): $_5d6a18e9c98ec=explode(',',$obj['type_extend']['area']); if(is_array($_5d6a18e9c98ec) || $_5d6a18e9c98ec instanceof \think\Collection || $_5d6a18e9c98ec instanceof \think\Paginator): if( count($_5d6a18e9c98ec)==0 ) : echo "" ;else: foreach($_5d6a18e9c98ec as $key=>$vo): ?>
			<dd><a<?php if($param['area']==$vo): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$vo,'year'=>$param['year'],'class'=>$param['class'],'by'=>$param['by']],'show'); ?>"><?php echo $vo; ?></a></dd>
			<?php endforeach; endif; else: echo "" ;endif; elseif($obj['parent']['type_extend']['area']): $_5d6a18e9c977a=explode(',',$obj['parent']['type_extend']['area']); if(is_array($_5d6a18e9c977a) || $_5d6a18e9c977a instanceof \think\Collection || $_5d6a18e9c977a instanceof \think\Paginator): if( count($_5d6a18e9c977a)==0 ) : echo "" ;else: foreach($_5d6a18e9c977a as $key=>$vo): ?>
			<dd><a<?php if($param['area']==$vo): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$vo,'year'=>$param['year'],'class'=>$param['class'],'by'=>$param['by']],'show'); ?>"><?php echo $vo; ?></a></dd>
			<?php endforeach; endif; else: echo "" ;endif; else: $_5d6a18e9c96e2=explode(',',$maccms['vod_extend_area']); if(is_array($_5d6a18e9c96e2) || $_5d6a18e9c96e2 instanceof \think\Collection || $_5d6a18e9c96e2 instanceof \think\Paginator): if( count($_5d6a18e9c96e2)==0 ) : echo "" ;else: foreach($_5d6a18e9c96e2 as $key=>$vo): ?>
			<dd><a<?php if($param['area']==$vo): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$vo,'year'=>$param['year'],'class'=>$param['class'],'by'=>$param['by']],'show'); ?>"><?php echo $vo; ?></a></dd>
			<?php endforeach; endif; else: echo "" ;endif; endif; ?>
		</dl>
		<dl>
			<dt>年代</dt>
			<dd><a<?php if($param['year']==''): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>'','class'=>$param['class'],'by'=>$param['by']],'show'); ?>">全部</a></dd>
			<?php if($obj['type_extend']['year']): $_5d6a18e9c952b=explode(',',$obj['type_extend']['year']); if(is_array($_5d6a18e9c952b) || $_5d6a18e9c952b instanceof \think\Collection || $_5d6a18e9c952b instanceof \think\Paginator): if( count($_5d6a18e9c952b)==0 ) : echo "" ;else: foreach($_5d6a18e9c952b as $key=>$vo): ?>
			<dd><a<?php if($param['year']==$vo): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$vo,'class'=>$param['class'],'by'=>$param['by']],'show'); ?>"><?php echo $vo; ?></a></dd>
			<?php endforeach; endif; else: echo "" ;endif; elseif($obj['parent']['type_extend']['year']): $_5d6a18e9c9395=explode(',',$obj['parent']['type_extend']['year']); if(is_array($_5d6a18e9c9395) || $_5d6a18e9c9395 instanceof \think\Collection || $_5d6a18e9c9395 instanceof \think\Paginator): if( count($_5d6a18e9c9395)==0 ) : echo "" ;else: foreach($_5d6a18e9c9395 as $key=>$vo): ?>
			<dd><a<?php if($param['year']==$vo): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$vo,'class'=>$param['class'],'by'=>$param['by']],'show'); ?>"><?php echo $vo; ?></a></dd>
			<?php endforeach; endif; else: echo "" ;endif; else: $_5d6a18e9c9273=explode(',',$maccms['vod_extend_year']); if(is_array($_5d6a18e9c9273) || $_5d6a18e9c9273 instanceof \think\Collection || $_5d6a18e9c9273 instanceof \think\Paginator): if( count($_5d6a18e9c9273)==0 ) : echo "" ;else: foreach($_5d6a18e9c9273 as $key=>$vo): ?>
			<dd><a<?php if($param['year']==$vo): ?> class="fed-this fed-text-green"<?php endif; ?> href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$vo,'class'=>$param['class'],'by'=>$param['by']],'show'); ?>"><?php echo $vo; ?></a></dd>
			<?php endforeach; endif; else: echo "" ;endif; endif; ?>
		</dl>
	</div>
...
<div class="fed-part-layout fed-back-whits">
	...
	<ul class="fed-list-info fed-part-rows">
		<?php $__TAG__ = '{"num":"48","pageurl":"vod\/show","paging":"yes","half":"3","type":"current","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;if(stristr($obj['type_name'],'直播')==true||stristr($obj['parent']['type_name|mac_filter_html'],'直播')==true): ?>
		<li class="fed-list-item fed-padding fed-col-xs6 fed-col-sm3">
