				...
				<div class="fed-pops-box">
					<div class="fed-pops-hot">
						...
						<ul class="fed-pops-list fed-back-whits fed-part-rows">
							<?php $_5d6a18f59a9a1=explode(',',$maccms['search_hot']); if(is_array($_5d6a18f59a9a1) || $_5d6a18f59a9a1 instanceof \think\Collection || $_5d6a18f59a9a1 instanceof \think\Paginator): if( count($_5d6a18f59a9a1)==0 ) : echo "" ;else: foreach($_5d6a18f59a9a1 as $key=>$vo): ?>
...
<div class="fed-part-layout fed-back-whits fed-part-height">
	<div class="fed-user-login fed-part-core">
		...
		<form class="fed-user-form fed-user-width fed-part-rows" action="<?php echo mac_url('user/login'); ?>" data-jump="<?php echo mac_url('user/index'); ?>">
