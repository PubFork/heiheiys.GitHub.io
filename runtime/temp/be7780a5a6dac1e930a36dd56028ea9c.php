<?php if (!defined('THINK_PATH')) exit(); /*a:20:{s:32:"template/vfed/html/vod/type.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/public/header.html";i:1558617932;s:64:"/www/wwwroot/heiheiys.top/template/vfed/html/public/include.html";i:1558681186;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/seokey.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/themes.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/navbar.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/tabbar.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/search.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/banner.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/screen.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/latest.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/advert.html";i:1558617932;s:64:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/listing.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/images.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/paging.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/public/footer.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/colors.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/global.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/caches.html";i:1567233713;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/quicks.html";i:1558617932;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="fed-pops-box">
					<div class="fed-pops-hot">
						...
						<ul class="fed-pops-list fed-back-whits fed-part-rows">
							<?php $_5d6a16dc00b33=explode(',',$maccms['search_hot']); if(is_array($_5d6a16dc00b33) || $_5d6a16dc00b33 instanceof \think\Collection || $_5d6a16dc00b33 instanceof \think\Paginator): if( count($_5d6a16dc00b33)==0 ) : echo "" ;else: foreach($_5d6a16dc00b33 as $key=>$vo): ?>
...
<div class="fed-scre-list fed-part-layout fed-back-whits fed-part-rows">
	<dl class="fed-col-sx12 fed-col-sm6 fed-col-md4">
		<dt><?php if($obj['childids']||$obj['parent']['childids']): ?>分类<?php else: ?>类型<?php endif; ?></dt>
		<?php if($obj['childids']||$obj['parent']['childids']): $__TAG__ = '{"num":"8","ids":"current","order":"asc","by":"sort","flag":"vod","id":"vo","key":"key"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
		<dd<?php if($key>8): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($vo,['area'=>$param['area'],'year'=>$param['year'],'class'=>$param['class']],'show'); ?>"><?php echo mac_filter_html($vo['type_name']); ?></a></dd>
		<?php endforeach; endif; else: echo "" ;endif; elseif($obj['type_extend']['class']): $_5d6a16dc00852=explode(',',$obj['type_extend']['class']); if(is_array($_5d6a16dc00852) || $_5d6a16dc00852 instanceof \think\Collection || $_5d6a16dc00852 instanceof \think\Paginator): if( count($_5d6a16dc00852)==0 ) : echo "" ;else: foreach($_5d6a16dc00852 as $key=>$vo): ?>
		<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$param['year'],'class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
		<?php endforeach; endif; else: echo "" ;endif; elseif($obj['parent']['type_extend']['class']): $_5d6a16dc007f6=explode(',',$obj['parent']['type_extend']['class']); if(is_array($_5d6a16dc007f6) || $_5d6a16dc007f6 instanceof \think\Collection || $_5d6a16dc007f6 instanceof \think\Paginator): if( count($_5d6a16dc007f6)==0 ) : echo "" ;else: foreach($_5d6a16dc007f6 as $key=>$vo): ?>
		<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$param['year'],'class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
		<?php endforeach; endif; else: echo "" ;endif; else: $_5d6a16dc007a0=explode(',',$maccms['vod_extend_class']); if(is_array($_5d6a16dc007a0) || $_5d6a16dc007a0 instanceof \think\Collection || $_5d6a16dc007a0 instanceof \think\Paginator): if( count($_5d6a16dc007a0)==0 ) : echo "" ;else: foreach($_5d6a16dc007a0 as $key=>$vo): ?>
		<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$param['year'],'class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
		<?php endforeach; endif; else: echo "" ;endif; endif; ?>
	</dl>
	<dl class="fed-col-sx12 fed-col-sm6 fed-col-md4 fed-hide-sm fed-show-md-block">
		<dt>年代</dt>
		<?php if($obj['type_extend']['year']): $_5d6a16dc00729=explode(',',$obj['type_extend']['year']); if(is_array($_5d6a16dc00729) || $_5d6a16dc00729 instanceof \think\Collection || $_5d6a16dc00729 instanceof \think\Paginator): if( count($_5d6a16dc00729)==0 ) : echo "" ;else: foreach($_5d6a16dc00729 as $key=>$vo): ?>
		<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$vo,'class'=>$param['class']],'show'); ?>"><?php echo $vo; ?></a></dd>
		<?php endforeach; endif; else: echo "" ;endif; elseif($obj['parent']['type_extend']['year']): $_5d6a16dc006b5=explode(',',$obj['parent']['type_extend']['year']); if(is_array($_5d6a16dc006b5) || $_5d6a16dc006b5 instanceof \think\Collection || $_5d6a16dc006b5 instanceof \think\Paginator): if( count($_5d6a16dc006b5)==0 ) : echo "" ;else: foreach($_5d6a16dc006b5 as $key=>$vo): ?>
		<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$vo,'class'=>$param['class']],'show'); ?>"><?php echo $vo; ?></a></dd>
		<?php endforeach; endif; else: echo "" ;endif; else: $_5d6a16dc0065d=explode(',',$maccms['vod_extend_year']); if(is_array($_5d6a16dc0065d) || $_5d6a16dc0065d instanceof \think\Collection || $_5d6a16dc0065d instanceof \think\Paginator): if( count($_5d6a16dc0065d)==0 ) : echo "" ;else: foreach($_5d6a16dc0065d as $key=>$vo): ?>
		<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$param['area'],'year'=>$vo,'class'=>$param['class']],'show'); ?>"><?php echo $vo; ?></a></dd>
		<?php endforeach; endif; else: echo "" ;endif; endif; ?>
	</dl>
	<dl class="fed-col-sx12 fed-col-sm6 fed-col-md4">
		<dt>地区</dt>
		<?php if($obj['type_extend']['area']): $_5d6a16dc005e1=explode(',',$obj['type_extend']['area']); if(is_array($_5d6a16dc005e1) || $_5d6a16dc005e1 instanceof \think\Collection || $_5d6a16dc005e1 instanceof \think\Paginator): if( count($_5d6a16dc005e1)==0 ) : echo "" ;else: foreach($_5d6a16dc005e1 as $key=>$vo): ?>
		<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$vo,'year'=>$param['year'],'class'=>$param['class']],'show'); ?>"><?php echo $vo; ?></a></dd>
		<?php endforeach; endif; else: echo "" ;endif; elseif($obj['parent']['type_extend']['area']): $_5d6a16dc00575=explode(',',$obj['parent']['type_extend']['area']); if(is_array($_5d6a16dc00575) || $_5d6a16dc00575 instanceof \think\Collection || $_5d6a16dc00575 instanceof \think\Paginator): if( count($_5d6a16dc00575)==0 ) : echo "" ;else: foreach($_5d6a16dc00575 as $key=>$vo): ?>
		<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$vo,'year'=>$param['year'],'class'=>$param['class']],'show'); ?>"><?php echo $vo; ?></a></dd>
		<?php endforeach; endif; else: echo "" ;endif; else: $_5d6a16dc004b9=explode(',',$maccms['vod_extend_area']); if(is_array($_5d6a16dc004b9) || $_5d6a16dc004b9 instanceof \think\Collection || $_5d6a16dc004b9 instanceof \think\Paginator): if( count($_5d6a16dc004b9)==0 ) : echo "" ;else: foreach($_5d6a16dc004b9 as $key=>$vo): ?>
		<dd<?php if($key>9): ?> class="fed-hide-sm"<?php endif; ?>><a href="<?php echo mac_url_type($obj,['area'=>$vo,'year'=>$param['year'],'class'=>$param['class']],'show'); ?>"><?php echo $vo; ?></a></dd>
		<?php endforeach; endif; else: echo "" ;endif; endif; ?>
	</dl>
</div>
<?php if($obj['childids']): if(stristr($obj['type_name'],'直播')==false&&stristr($obj['parent']['type_name'],'直播')==false): if($vfedcc['home']['video']['state']): ?>
...
<?php endif; endif; $__TAG__ = '{"ids":"current","order":"asc","by":"sort","id":"vo","key":"key"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
<div class="fed-part-layout fed-back-whits">
	<div class="fed-list-head fed-part-rows fed-padding">
		<h2 class="fed-font-xvi"><?php echo mac_filter_html($vo['type_name']); ?></h2>
		<ul class="fed-part-tips fed-padding">
			<li><a class="fed-more" href="<?php echo mac_url_type($vo); ?>">更多</a></li>
		</ul>
	</div>
	<?php if(stristr($obj['type_name'],'直播')==true||stristr($obj['parent']['type_name'],'直播')==true): ?>
...
<div class="fed-part-layout fed-back-whits">
	<div class="fed-list-head fed-part-rows fed-padding">
		<h2 class="fed-font-xvi"><?php echo mac_filter_html($obj['type_name']); ?></h2>
		<ul class="fed-part-tips fed-padding">
	...
	<?php if(stristr($obj['type_name'],'直播')==true||stristr($obj['parent']['type_name'],'直播')==true): ?>
	<ul class="fed-list-info fed-list-img fed-part-rows">
		<?php $__TAG__ = '{"num":"48","paging":"yes","half":"3","type":"current","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
		<li class="fed-list-item fed-padding fed-col-xs6 fed-col-sm4 fed-col-md3">
		<a class="fed-list-pics fed-lazy fed-part-5by3" href="<?php echo mac_url_vod_play($vo,['sid'=>1,'nid'=>1]); ?>" data-original="<?php echo mac_url_img($vo['vod_pic']); ?>">
	<span class="fed-list-play fed-hide-xs"></span>
	<span class="fed-list-score fed-font-xii fed-text-white fed-back-green"><?php echo mac_default($vo['vod_remarks'],$vo['vod_hits'].'播放'); ?></span>
