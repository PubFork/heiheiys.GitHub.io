<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:36:"template/vfed/html/comment/ajax.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/comment/input.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/paging.html";i:1558617932;}*/ ?>
<form class="fed-comm-fort fed-comm-form" id="fed-comm-form" data-role="<?php echo $comment['login']; ?>" autocomplete="off" onkeydown="if(event.keyCode==13){return false}">
	...
	<ul class="fed-part-rows">
		...
		<li class="fed-padding<?php if($GLOBALS['config']['comment']['verify']): ?> fed-col-xs12 fed-col-md4<?php else: ?> fed-col-xs9 fed-col-md10<?php endif; ?>">
			<p class="fed-form-info fed-rims-info fed-text-muted">提示：<span class="fed-comm-tips">还可以输入255字</span></p>
		</li>
		<?php if($GLOBALS['config']['comment']['verify']): ?>
		...
		<li class="fed-padding fed-col-xs3 fed-col-md2">
			<a class="fed-form-info fed-rims-info fed-btns-info fed-btns-green fed-comm-submit" href="javascript:;">发表</a>
		</li>
	</ul>
</form>
	...
	<li class="fed-comm-each fed-part-rows fed-line-top fed-margin">
		...
		<div class="fed-comm-cont">
			...
			<div class="fed-comm-reply fed-back-ashen<?php if($key==0): ?> fed-comm-tops<?php else: ?> fed-line-top<?php endif; ?>">
				<img class="fed-comm-avat fed-part-roun" src="<?php  echo mac_get_user_portrait($child['user_id']);  ?>"/>
				<div class="fed-comm-head">
				...
				<div class="fed-comm-cont">
					<?php echo mac_em_replace($child['comment_content']); ?>
					<div class="fed-comm-action fed-text-right fed-font-xii">
