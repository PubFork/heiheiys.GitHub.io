<?php if (!defined('THINK_PATH')) exit(); /*a:13:{s:32:"template/vfed/html/user/reg.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/public/header.html";i:1558617932;s:64:"/www/wwwroot/heiheiys.top/template/vfed/html/public/include.html";i:1558681186;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/seokey.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/themes.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/navbar.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/tabbar.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/search.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/public/footer.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/colors.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/global.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/caches.html";i:1567147273;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/quicks.html";i:1558617932;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="fed-pops-box">
					<div class="fed-pops-hot">
						...
						<ul class="fed-pops-list fed-back-whits fed-part-rows">
							<?php $_5d6955a42f85b=explode(',',$maccms['search_hot']); if(is_array($_5d6955a42f85b) || $_5d6955a42f85b instanceof \think\Collection || $_5d6955a42f85b instanceof \think\Paginator): if( count($_5d6955a42f85b)==0 ) : echo "" ;else: foreach($_5d6955a42f85b as $key=>$vo): ?>
...
<div class="fed-part-layout fed-back-whits fed-part-height"<?php if($user_config['reg_phone_sms']!=0||$user_config['reg_email_sms']!=0): ?> style="min-height:35rem"<?php endif; ?>>
	<div class="fed-user-login fed-part-core">
		<div class="fed-list-head fed-part-rows fed-padding">
			<h2 class="fed-font-xvii fed-text-center">会员注册</h2>
		</div>
		<form class="fed-user-form fed-user-width fed-part-rows" action="<?php echo mac_url('user/reg'); ?>" data-role="<?php echo mac_url('user/reg_msg'); ?>" data-jump="<?php echo mac_url('user/login'); ?>" data-user="<?php echo $_GET['uid']; ?>">
			<input class="fed-user-text fed-col-xs12" type="text" name="user_name" placeholder="请输入账号" />
			<input class="fed-user-text fed-col-xs12" type="password" name="user_pwd" placeholder="请输入密码" maxlength="20" />
			<input class="fed-user-text fed-col-xs12" type="password" name="user_pwd2" placeholder="再次输入密码" maxlength="20" />
			<?php if($user_config['reg_phone_sms']!=0): ?>
			<input type="hidden" name="ac" value="phone">
			<input type="text" class="fed-user-text fed-col-xs12" name="to" placeholder="请输入手机号">
			<input type="text" class="fed-user-text fed-col-xs8" name="code" placeholder="请输入手机验证码">
			<a class="fed-user-bind fed-user-text fed-col-xs4 fed-text-right" href="javascript:;">获取验证码</a>
			<?php elseif($user_config['reg_email_sms']!=0): ?>
			<input type="hidden" name="ac" value="email">
			<input type="text" class="fed-user-text fed-col-xs12" name="to" placeholder="请输入邮箱">
			<input type="text" class="fed-user-text fed-col-xs8" name="code" placeholder="请输入邮箱验证码">
			<a class="fed-user-bind fed-user-text fed-col-xs4 fed-text-right" href="javascript:;">获取验证码</a>
			...
			<?php endif; ?>
			<a class="fed-padding fed-col-xs3 fed-text-right" href="<?php echo mac_url('user/login'); ?>">立即登录</a>
		</form>
	</div>
</div>
