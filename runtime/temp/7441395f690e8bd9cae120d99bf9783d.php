<?php if (!defined('THINK_PATH')) exit(); /*a:20:{s:34:"template/vfed/html/art/search.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/public/header.html";i:1558617932;s:64:"/www/wwwroot/heiheiys.top/template/vfed/html/public/include.html";i:1558681186;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/seokey.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/themes.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/navbar.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/tabbar.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/search.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/inform.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/paging.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/module/relate.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/lucida.html";i:1558617932;s:64:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/picture.html";i:1558617932;s:64:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/listing.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/images.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/public/footer.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/colors.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/global.html";i:1558617932;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/caches.html";i:1567233713;s:63:"/www/wwwroot/heiheiys.top/template/vfed/html/basics/quicks.html";i:1558617932;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="fed-pops-box">
					<div class="fed-pops-hot">
						...
						<ul class="fed-pops-list fed-back-whits fed-part-rows">
							<?php $_5d6a1c8c1bd35=explode(',',$maccms['search_hot']); if(is_array($_5d6a1c8c1bd35) || $_5d6a1c8c1bd35 instanceof \think\Collection || $_5d6a1c8c1bd35 instanceof \think\Paginator): if( count($_5d6a1c8c1bd35)==0 ) : echo "" ;else: foreach($_5d6a1c8c1bd35 as $key=>$vo): ?>
...
<div class="fed-part-layout fed-back-whits">
	<div class="fed-list-head fed-part-rows fed-padding">
		<h2 class="fed-font-xvi">
			搜索到与&nbsp;“<span class="fed-text-green fed-text-bold"><?php echo $param['wd']; ?><?php echo $param['actor']; ?><?php echo $param['director']; ?><?php echo $param['area']; ?><?php echo $param['lang']; ?><?php echo $param['year']; ?><?php echo $param['class']; ?></span>”&nbsp;相关的&nbsp;“<span id="fed-count" class="fed-text-green fed-text-bold">0</span>”&nbsp;条结果
		</h2>
		<ul class="fed-part-tips fed-padding">
			<li><span class="fed-more fed-hide-xs">当前第&nbsp;<span id="fed-now" class="fed-text-green fed-text-bold">1</span>&nbsp;页</span></li>
		</ul>
	</div>
	<?php $__TAG__ = '{"num":"10","paging":"yes","half":"3","pageurl":"art\/search","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Art")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
...
<?php endif; if(empty($__PAGING__['record_total']) || (($__PAGING__['record_total'] instanceof \think\Collection || $__PAGING__['record_total'] instanceof \think\Paginator ) && $__PAGING__['record_total']->isEmpty())): ?>
	<div class="fed-padding">很抱歉，暂无相关文章！</div>
	<?php endif; ?>
</div>
<?php if(empty($__PAGING__['record_total']) || (($__PAGING__['record_total'] instanceof \think\Collection || $__PAGING__['record_total'] instanceof \think\Paginator ) && $__PAGING__['record_total']->isEmpty())): if($vfedcc['home']['actor']['state']): $__TAG__ = '{"num":"1","name":"'.$obj['vod_actor'].'","key":"actors","id":"vo"}';$__LIST__ = model("Actor")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $actors = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($actors % 2 );++$actors;endforeach; endif; else: echo "" ;endif; if($actors): ?>
<div class="fed-part-layout fed-back-whits">
	<div class="fed-list-head fed-part-rows fed-padding">
