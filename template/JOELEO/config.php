...
$muchoConfig = array(
    // 基本设置
    'logo' => '嘿嘿影视',    // LOGO 设置：若为空则显示图片（后台上传即可），不为空则显示文字
    
    'theme' => 'cherry',    // 默认主题设置：樱桃：cherry ；橘子：orange ；葡萄：grape ；青柠：cyan ；炫彩：colorful ；黑金：black ；
    
    'islider' => '1',    // 首页今日推荐： 1 为滑动显示 0为排列显示 默认滑动·
    
    'islast' => '0',    // 首页最新更新（带排行榜）： 1 为开启 0为关闭 默认关闭·
    
    'isweekday' => '1',    // 首页一周放送表： 1 为开启 0为关闭 默认开启·
    ...
    'dataoke' => array(
        ...
        'state' => '1', // 是否在更多中显示： 1 为显示 0为不显示 默认显示·
